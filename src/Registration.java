...
public void setIcon()
    ...
    private void initComponents() {
        ...
        facility = new javax.swing.JMenuItem();
        jSeparator1 = new javax.swing.JPopupMenu.Separator();
        availablelity = new javax.swing.JMenuItem();
        ...
        jLabel2.setText("Room's Registration");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 500, 90));

        jLabel3.setFont(new java.awt.Font("Viner Hand ITC", 3, 24)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Priyanka Palace");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 630, 230, 30));
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 550, 110, 30));
        ...
        facility.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F, java.awt.event.InputEvent.ALT_MASK | java.awt.event.InputEvent.CTRL_MASK));
        facility.setText("Customer Facility");
        ...
        availablelity.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_A, java.awt.event.InputEvent.ALT_MASK | java.awt.event.InputEvent.CTRL_MASK));
        availablelity.setText("Check Availability");
        availablelity.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                availablelityActionPerformed(evt);
            }
        });
        jMenu1.add(availablelity);

        view.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_B, java.awt.event.InputEvent.CTRL_MASK));
        view.setText("Bill View");
        ...
        Record.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_B, java.awt.event.InputEvent.ALT_MASK | java.awt.event.InputEvent.CTRL_MASK));
        Record.setText("Bill Record");
        ...
        All.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_V, java.awt.event.InputEvent.ALT_MASK | java.awt.event.InputEvent.CTRL_MASK));
        All.setText("View Customer");
        ...
        change.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_P, java.awt.event.InputEvent.ALT_MASK | java.awt.event.InputEvent.CTRL_MASK));
        ...
        out.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_Q, java.awt.event.InputEvent.CTRL_MASK));
        out.setText("Log Out");
             ...
             try
        {
            ...
            int p=JOptionPane.showConfirmDialog(null,"Do you want to save","Conform Save",JOptionPane.YES_NO_OPTION);
             ...
             JOptionPane.showMessageDialog(null, "Saved");  
              ...
              new Living_Facility(aa,bb).setVisible(true);
              dispose();
             }
        }
    ...
    private void new_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_new_btnActionPerformed
        ...
        romm_txt.setSelectedIndex(0);
        type_txt.setSelectedIndex(0);
        ((JTextField)date_1.getDateEditor().getUiComponent()).setText("");
        ((JTextField)date_2.getDateEditor().getUiComponent()).setText("");
    ...
    private void update_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_update_btnActionPerformed
        ...
        String a=name_txt.getText();
         String b=Id_txt.getText();
          String c=mobile_txt.getText();
           String d=Profession_txt.getText();
            String e=romm_txt.getSelectedItem().toString();
             String f=type_txt.getSelectedItem().toString();
              String g=((JTextField)date_1.getDateEditor().getUiComponent()).getText();
               String h=((JTextField)date_2.getDateEditor().getUiComponent()).getText();
              ...
              try
        {
                  ...
                  switch (select_txt.getSelectedItem().toString()) {
                      case "Name":
                          {
                              String update_sql="update Registration set Name='"+a+"',ID='"+b+"',Mobile='"+c+"',Profession='"+d+"',Room='"+e+"',RoomType='"+f+"',CheckIn='"+g+"',CheckOut='"+h+"' where Name='"+search_txt.getText()+"'";
                      ...
                      case "ID":
                          {
                              String update_sql="update Registration set Name='"+a+"',ID='"+b+"',Mobile='"+c+"',Profession='"+d+"',Room='"+e+"',RoomType='"+f+"',CheckIn='"+g+"',CheckOut='"+h+"' where ID='"+search_txt.getText()+"'";
                              pst=conn.prepareStatement(update_sql);
                              pst.execute();
                              JOptionPane.showMessageDialog(null, "Update Successfully");
                              break;
         ...
         else
         {
             try
             {
                 switch (select_txt.getSelectedItem().toString()) {
                     case "Name":
                         {
                             String delete_sql="delete from Registration where Name='"+search_txt.getText()+"'";
                     ...
                     case "ID":
                         {
                             String delete_sql="delete from Registration where ID='"+search_txt.getText()+"'";
                             pst=conn.prepareStatement(delete_sql);
                             int p=JOptionPane.showConfirmDialog(null,"Do you want to Delete","Conform Delete",JOptionPane.YES_NO_OPTION);
                             if(p==0)
                             {
    ...
    private void availablelityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_availablelityActionPerformed
        // TODO add your handling code here:
        new Check_availability().setVisible(true);
        dispose();
    }//GEN-LAST:event_availablelityActionPerformed
    ...
    private javax.swing.JMenuItem availablelity;
    ...
    private javax.swing.JMenuItem facility;
